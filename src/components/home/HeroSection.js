...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[80vh] md:min-h-[85vh] flex items-center justify-center overflow-hidden bg-gradient-hero">
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            <div className="relative pt-3">
              <motion.div
                ...
                className="w-20 h-20 md:w-20 md:h-20 rounded-full flex items-center justify-center"
              >
                <Image
                  src={logoImage}
                  alt="Ariz Group Logo"
                  width={60}
                  height={60}
                  className="w-12 h-12 md:w-20 md:h-16 object-contain"
                />
              </motion.div>
          ...
          >
            <span className="bg-gradient-to-r from-neon-blue to-neon-cyan bg-clip-text text-transparent">
              {t('hero.title', 'Your Supply Chain Solutions')
                .split(' ')
                .slice(0, 2)
                .join(' ')}
            </span>
